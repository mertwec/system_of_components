...
if __name__ == "__main__":
    ...
    ;SS24;VD1;SMA;SS24 anal:ss26\r\n1;HY-STM32V;M1;HY-STM32V;\r\n2;JMP3;J1;JMP_3;\r\n;JMP3;J2;JMP_3;\r\n '''

    map_rc = {'C': 'capacitor', 'R': 'resistor', 'ZQ': 'quartz', 'L': 'inductance', 'VD': 'diode', 'VT': 'transistor',
              'DA': 'integrated circuit analog', 'DD': 'integrated circuit digital', 'X': 'connector'}
    ...
    out = parsing_components(suc[1], map_rc)
    print(out)
    for i in out:
        pprint.pprint(f"{i['pattern_name']}: {i['value']} {i['comment']}")
